...
$$
m_{кр1}=0.002k_{м}m_0n_{max}f\left(0.6\left(\frac{\sqrt{S\lambda}}{2}\right)^2+1\right)+3S; m_{кр2}=0.0001k_{м}m_0n_{max}f\lambda(\eta+3)\sqrt{S/\eta}\sqrt{\varepsilon}; \bar{m}_{кр}=\frac{m_{кр1}+m_{кр2}}{2m_0}
$$
...
- `n_max` = `2.5`
- `f` = `2`
- `m_wing_1` = `1973.175558`
- `m_wing_2` = `159.05049`

**Result:**

`iteration_1.wing_mass_ratio` = `0.185077`
...
`iteration_1.tail_mass_ratio` = `0.010132`
...
`iteration_1.structure_mass_ratio` = `0.317511`
...
- `structure_mass_ratio` = `0.317511`
- `powerplant_mass_ratio` = `0.139798`
- `special_equipment_mass_ratio` = `0.11`
- `fuel_mass_ratio` = `0.039329`
- `denominator` = `0.393362`
- `iteration` = `1`
- `numerator` = `2020`

**Result:**

`iteration_1.updated_m0` = `5135.222951` `kg`

---

### 12. iteration_2.wing_mass_ratio
...
- `n_max` = `2.5`
- `f` = `2`
- `m_wing_1` = `1578.994629`
- `m_wing_2` = `133.87408`

**Result:**

`iteration_2.wing_mass_ratio` = `0.166776`

---

### 13. iteration_2.fuselage_mass_ratio
...
`iteration_2.fuselage_mass_ratio` = `0.082546`

---

### 14. iteration_2.tail_mass_ratio
...
`iteration_2.tail_mass_ratio` = `0.009902`

---

### 15. iteration_2.landing_gear_mass_ratio
...
`iteration_2.landing_gear_mass_ratio` = `0.0419`

---

### 16. iteration_2.structure_mass_ratio
...
- `iteration` = `2`
- `wing_ratio` = `0.166776`
- `fuselage_ratio` = `0.082546`
- `tail_ratio` = `0.009902`
- `landing_gear_ratio` = `0.0419`

**Result:**

`iteration_2.structure_mass_ratio` = `0.301124`

---

### 17. iteration_2.ice_powerplant_mass_ratio
...
`iteration_2.ice_powerplant_mass_ratio` = `0.156817`

---

### 18. iteration_2.updated_m0
...
- `structure_mass_ratio` = `0.301124`
- `powerplant_mass_ratio` = `0.156817`
- `special_equipment_mass_ratio` = `0.11`
- `fuel_mass_ratio` = `0.039329`
- `denominator` = `0.39273`
- `iteration` = `2`
...
`iteration_2.updated_m0` = `5143.487775` `kg`

---

### 19. S_W

Итоговая площадь крыла.
...
- `L_fuselage` = `58.261657`
- `lambda_fuselage` = `9`

**Result:**

`fuselage_diameter` = `6.473517` `m`
...
`wing_vertical_position` = `3.236759` `m`
...
`horizontal_tail_area` = `48.343654` `m²`
...
`horizontal_tail_span` = `13.90592` `m`
...
`horizontal_tail_root_chord` = `5.21472` `m`
...
`horizontal_tail_tip_chord` = `1.73824` `m`
...
`horizontal_tail_x_position` = `36.696243` `m`
...
`vertical_tail_area` = `29.006192` `m²`
...
`vertical_tail_root_chord` = `5.863251` `m`
...
`vertical_tail_tip_chord` = `2.931625` `m`
...
`vertical_tail_x_position` = `36.696243` `m`
